                                                                                        ...
                                                                                        <form method="POST" action="{{ route('tickets.assign', $ticket) }}"
                                                                                            ...
                                                                                            <div class="flex flex-wrap items-center justify-end gap-2">
                                                                                                <select name="it_member_id" required
                                                                                                    class="block w-44 rounded-md border-slate-300 text-sm shadow-sm focus:border-blue-500 focus:ring-blue-500">
                                                                                                ...
                                                                                                <div class="flex flex-col">
                                                                                                    <label class="text-xs text-slate-600 mb-1">Completion Date *</label>
                                                                                            ...
                                                                                            <textarea name="it_instructions" rows="2"
                                                                                                ...
                                                                                                class="block w-[22rem] max-w-full rounded-md border-slate-300 text-sm shadow-sm focus:border-blue-500 focus:ring-blue-500"></textarea>
