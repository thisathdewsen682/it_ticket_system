        ...
        <div class="max-w-screen-2xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden border border-emerald-200 shadow-lg sm:rounded-xl">
                <div class="p-8 text-gray-900">
                    <div
                        class="mb-6 text-sm text-gray-700 font-medium bg-emerald-50 border border-emerald-200 rounded-lg p-4">
                    ...
                    <div class="mb-6 flex flex-wrap items-center gap-2">
                        <a href="{{ route('dashboard.manager', ['tab' => 'pending']) }}"
                            class="inline-flex items-center rounded-lg border px-4 py-2 text-sm font-semibold transition-all shadow-sm {{ $tab === 'pending' ? 'border-emerald-500 bg-emerald-600 text-white shadow-md' : 'border-gray-300 bg-white text-gray-700 hover:bg-emerald-50 hover:border-emerald-300' }}">
                            Pending
                        </a>
                                            ...
                                            <tr
                                                ...
                                                <td class="whitespace-nowrap px-4 py-3 text-sm font-semibold text-gray-900">
                                                    <button type="button" x-data=""
                                                        class="text-emerald-700 hover:text-emerald-900 hover:underline font-semibold"
                                                        ...
                                                        <div class="p-6">
                                                            <div class="flex items-start justify-between gap-4">
                                                                <div>
                                                                    ...
                                                                    <div class="mt-1 text-sm text-gray-600">{{ $ticket->title }}
                                                                    </div>
                                                                </div>
                                                                <x-secondary-button
