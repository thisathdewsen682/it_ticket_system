                ...
                <div class="p-8 text-gray-900">
                    ...
                    <div class="mb-6 flex flex-wrap items-center gap-2">
                        ...
                        <a href="{{ route('dashboard.it_member', ['tab' => 'reopened']) }}"
                            class="inline-flex items-center rounded-lg border px-4 py-2 text-sm font-semibold transition-all shadow-sm {{ $tab === 'reopened' ? 'border-emerald-500 bg-emerald-600 text-white shadow-md' : 'border-gray-300 bg-white text-gray-700 hover:bg-emerald-50 hover:border-emerald-300' }}">
                            Reopened
                        </a>
                                ...
                                <table class="min-w-full divide-y divide-emerald-200">
                                    ...
                                    <tbody class="divide-y divide-gray-200 bg-white">
                                        @foreach ($tickets as $ticket)
                                            <tr class="odd:bg-white even:bg-emerald-50/30 hover:bg-emerald-50 transition-colors">
                                                <td class="whitespace-nowrap px-4 py-3 text-sm font-semibold text-gray-900">
                                                    <button type="button" x-data="" class="text-emerald-700 hover:text-emerald-900 hover:underline font-semibold"
                                                ...
                                                <td class="whitespace-nowrap px-4 py-3 text-right">
                                                    ...
                                                    @else
                                                        <span class="text-sm text-gray-700">{{ $ticket->status }}</span>
                                                    @endif
