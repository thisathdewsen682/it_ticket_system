@extends('emails.layout', ['headerColor' => '#db2777', 'headerColorDark' => '#be185d', 'accentColor' => '#db2777'])

@section('header')
    <h1>🔁 Ticket Reopened by Requester</h1>
...
@section('content')
    ...
    <p class="message">
        The requester has reopened this ticket. Please review and reassign an IT member if needed.
    </p>
