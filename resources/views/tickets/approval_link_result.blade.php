<x-guest-layout>
    <div class="space-y-3">
        ...
        <div class="pt-2 flex gap-4">
            <a href="{{ route('tickets.show', $ticket) }}" class="text-sm font-medium text-emerald-700 hover:underline">
                View Full Ticket Details
            </a>
            <a href="{{ url('/') }}" class="text-sm font-medium text-gray-600 hover:underline">
                Go to Home
            </a>
        </div>
    </div>
